...
const SLIDES = [
  {
    ...
    subtitle: <>Descubra a nova coleção Outono/Inverno com peças<br className={styles.mobileBreak} /> exclusivas que definem o seu estilo.</>,
    cta: 'Ver Coleção',
  ...
  },
  {
    ...
    subtitle: <>O equilíbrio perfeito entre o casual e o<br className={styles.mobileBreak} /> sofisticado para o homem moderno.</>,
    cta: 'Explorar',
  ...
  },
  {
    ...
    subtitle: <>Peças selecionadas com qualidade ouro<br className={styles.mobileBreak} /> e descontos de até 40% OFF.</>,
    cta: 'Ver Ofertas',
    link: '/loja',
    badge: null,
  },
